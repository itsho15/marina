...
class BookingController extends Controller {
	...
	public function index($name = null) {
		switch ($name) {
		case 'persons':
			return view('booking.personal.persons');
			break;
		case 'companies':
	...
	public function step1() {
		...
		return view('booking.personal.contract');
	}
	...
	public function step2() {
		...
		if ($validator->fails()) {
			return view('booking.personal.contract')->withErrors($validator);
		} else {
	...
	public function step5() {
		...
		if (request('sender_code')) {
			...
			if (request('sender_code') == session('user_data')['code']) {
				...
				return view('booking.personal.code_verfiy');
			}
